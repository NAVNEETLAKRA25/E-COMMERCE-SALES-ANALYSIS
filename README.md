...
![Executive Insights](Images/pbi%20executive%20insights.png)
...
- VIP and Loyal customers drove most business revenue.
...
- Increase Q4 marketing campaigns.
...
```bash
POSTGRE SQL/E-Commerce Sales Analysis.sql
```
